...
import type {
  ...
  JpAlgorithmRequest,
  JpAlgorithmResult,
  PictorialChatRequest,
  PictorialChatResponse,
 ...
 */
export const getRunJpAlgorithmUrl = () => {
  return `/api/iap/plan`;
};

export const runJpAlgorithm = async (
  jpAlgorithmRequest: JpAlgorithmRequest,
  options?: RequestInit,
): Promise<JpAlgorithmResult> => {
  return customFetch<JpAlgorithmResult>(getRunJpAlgorithmUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(jpAlgorithmRequest),
  });
};

export const getRunJpAlgorithmMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof runJpAlgorithm>>,
    TError,
    { data: BodyType<JpAlgorithmRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["runJpAlgorithm"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return runJpAlgorithm(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type RunJpAlgorithmMutationResult = NonNullable<
  Awaited<ReturnType<typeof runJpAlgorithm>>
>;
export type RunJpAlgorithmMutationBody = BodyType<JpAlgorithmRequest>;
export type RunJpAlgorithmMutationError = ErrorType<unknown>;

/**
 * @summary Run JP Algorithm — regressive planning
 */
export const useRunJpAlgorithm = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getRunJpAlgorithmMutationOptions(options));
};

/**
 * @summary IAP pictorial communication for aphasia support (Gemma 4)
 */
export const getPictorialChatUrl = () => {
  return `/api/iap/pictoric-chat`;
};

export const pictorialChat = async (
  pictorialChatRequest: PictorialChatRequest,
  options?: RequestInit,
): Promise<PictorialChatResponse> => {
  return customFetch<PictorialChatResponse>(getPictorialChatUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(pictorialChatRequest),
  });
};

export const getPictorialChatMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof pictorialChat>>,
    TError,
    { data: BodyType<PictorialChatRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["pictorialChat"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return pictorialChat(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type PictorialChatMutationResult = NonNullable<
  Awaited<ReturnType<typeof pictorialChat>>
>;
export type PictorialChatMutationBody = BodyType<PictorialChatRequest>;
export type PictorialChatMutationError = ErrorType<unknown>;

/**
 * @summary IAP pictorial communication for aphasia support (Gemma 4)
 */
export const usePictorialChat = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getPictorialChatMutationOptions(options));
};

/**
 * @summary Compute topological distance between states
 */
export const getComputeTopologyUrl = () => {
  return `/api/iap/topology`;
};

export const computeTopology = async (
  topologyRequest: TopologyRequest,
  options?: RequestInit,
): Promise<TopologyResult> => {
  return customFetch<TopologyResult>(getComputeTopologyUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(topologyRequest),
  });
};

export const getComputeTopologyMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof computeTopology>>,
    TError,
    { data: BodyType<TopologyRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["computeTopology"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return computeTopology(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ComputeTopologyMutationResult = NonNullable<
  Awaited<ReturnType<typeof computeTopology>>
>;
export type ComputeTopologyMutationBody = BodyType<TopologyRequest>;
export type ComputeTopologyMutationError = ErrorType<unknown>;

/**
 * @summary Compute topological distance between states
 */
export const useComputeTopology = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getComputeTopologyMutationOptions(options));
};
